...
{
    private const string GENERATED_BY = 'samlitowitz/php-radix-tree-generator';
    private const string GENERATED_FILE_HEADER = <<<'PHP'
<?php
...
// source: %s
PHP;
    private const string SOURCE_TEMPLATE = __DIR__ . '/../../assets/templates/radix-tree.php';

    public function __construct(
        private readonly Target $target,
        private readonly Iterator $dataIter,
    ...
    private function writePHPSource(array $ast): void
    {
        ...
        // pretty printer does not print comments so we do a bit of a cheat
        // REFURL: https://github.com/nikic/PHP-Parser/issues/273
        $replacementHeader = sprintf(
            self::GENERATED_FILE_HEADER,
            self::GENERATED_BY,
            $this->source
        );
        $code = $replacementHeader . substr($code, 5);
